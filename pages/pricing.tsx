    ...
    return(
       ...
       <Navbar/>
            ...
            <div className="bg-light-navy py-10">
                <h1 className="font-bold text-6xl text-center text-beige">Choose the perfect plan for you.</h1>    
            </div>

        <div className="bg-light-navy">
            
            <div className="sm:flex flex-wrap justify-center items-center gap-8">
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-beige mt-6 shadow-lg rounded-lg">
                        <div className="px-6 py-8 sm:p-10 sm:pb-6">
                            <div className="flex justify-center">
                                <span className="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase text-navy">
                        ...
                        <p className="text-md mt-4 text-navy">
                            Plan includes:
                        </p>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-gold mt-6 shadow-lg rounded-lg">
                        <div className="px-6 py-8 sm:p-10 sm:pb-6">
                            <div className="flex justify-center">
                                <span className="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase text-navy">
                                    Graduate Degree
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-beige">Frequently asked questions</h2>
                    <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 items-center">
                        <div>
                            <div className="mb-10">
                                <h3 className="flex items-center mb-4 text-lg font-medium text-gold">
                                ...
                                <p className="text-beige">Our pricing is based on tuition, room, board, transportation, mandatory fees, and <a href='https://admission.princeton.edu/cost-aid/fees-payment-options#:~:text=Estimated%20miscellaneous%20expenses%3A%20%243%2C500' className="text-blue-500">estimated miscellaneous expenses</a>. </p>
                            </div>
                            <div className="mb-10">                        
                                <h3 className="flex items-center mb-4 text-lg font-medium text-gold">
                                    <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                                ...
                                <p className="text-beige">Yes. <a href='https://studentaid.gov/h/apply-for-aid/fafsa' className="text-blue">Contact sales</a> to discuss your options.</p>
                            </div>
                            <div className="mb-10">
                                <h3 className="flex items-center mb-4 text-lg font-medium text-gold">
                                    <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                                ...
                                <p className="text-beige">After paying your initial deposit, you are allowed to cancel your Grandeur plan at any time.</p>
                            </div>
                            <div className="mb-10">
                                <h3 className="flex items-center mb-4 text-lg font-medium text-gold">
                                    <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
