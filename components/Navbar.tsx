            ...
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <a href="/">
                <div className=' flex items-center'>
                  <img src="\img\better.png" alt="grandeur logo" className='mt-2'/>
                  <h2 className="text-xl text-beige font-bold">grandeur</h2> 
                </div>                
              </a>
              <div className="md:hidden">
                <button
                  className="p-2 text-beige rounded-md outline-none"
          ...
          <div>
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                <li className="block py-2 pr-4 pl-3 text-lg text-beige rounded font-bold hover:underline">
                  <a href={randLink()}>
                    Product
                  </a>
                </li>
                ...
                <li className="block py-2 pr-4 pl-3 text-lg text-beige roundedunderline">
                  <a href={randApplyLink()}>
                    <button className="bg-gold text-navy hover:underline py-2 px-4 rounded font-bold">
                        Sign up
                    </button>
                  </a>
                </li>
