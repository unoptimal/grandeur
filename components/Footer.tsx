...
export default function Navbar() {
	...
	return (
        ...
        <div className="py-6 px-4 bg-amber-50 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://unoptimal.com/">Grandeur</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                ...
                <a href="https://unoptimal.com/" target='blank' className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
